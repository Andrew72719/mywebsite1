...
const activities = [
    ...
    image:'https://i.epochtimes.com/assets/uploads/2014/11/140904233240985.jpg'
	},
	{
		title: 'FGO',
		description: 'FGO是一個能培養自制力和讓人理解到自身運氣的軟體。',
    image:'https://upload.wikimedia.org/wikipedia/zh/5/52/Fate_Grand_Order.png'
	}
]
const makeClass = (i) => (
	i % 2 === 0 ?
